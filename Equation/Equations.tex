...
\begin{enumerate}
  ...
  \item &\mathrm{S}_n=a_1+a_1 r+a_1 r^2+a_1 r^3+\cdots+a_1 r^{n-1} \\

    \item &\mathrm{~S}_n=a_1 r+a_1 r^2+a_1 r^3+\cdots+a_1 r^{n-1}+a_1 r^n \\

    \item &\mathrm{~S}_{\mathrm{n}}-\mathrm{rS}_{\mathrm{n}}=\mathrm{a}_1-\mathrm{a}_1 \mathrm{r}^{\mathrm{n}} \\
    
    \item &\mathrm{S}_{\mathrm{n}}(1-\mathrm{r})=\mathrm{a}_1\left(1-\mathrm{r}^{\mathrm{n}}\right) \\

    \item &\mathrm{S}_{\mathrm{n}}=\frac{\mathrm{a}_1\left(1-\mathrm{r}^{\mathrm{n}}\right)}{(1-\mathrm{r})}\\
